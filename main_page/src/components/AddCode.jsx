...
function AddCode({ togglePopup }) {
    ...
    return(
        <div>
            ...
            transform: 'translate(50%, -50%)', zIndex: 101, width: 1100, height: 700, 
            ...
            <textarea value={code} onChange={handleTextCode} placeholder="Type your code here..." onKeyDown={handleKeyDownOfCode} style={{background: '#ececec', border: '1px solid #e0e0e0', height: 400, width: 1100, fontSize: 15, color: 'green' }} type="text"></textarea>
            <textarea value={comment} onChange={handleTextComment} placeholder="Comments..." style={{ border: '0px solid #f1f1f1', height: 150, width: 1100, fontFamily: 'Arial', fontSize: 15, color: 'gray', marginTop: 5 }} type="text"></textarea>
            <br/>
            <div>
